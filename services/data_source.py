...
def _real_timeline() -> pd.DataFrame:
    ...
    # Barrister_Source_of_Truth_Master_v5_Four_Month_Financial_Closeout_Through_Event94_2026-08-05.xlsx
    # 94 completed events, city-level location on every row.
    # Verified? = "Yes" when Revenue was confirmed in the workbook,
    # "No" for the 2 flagged payment-breakdown-pending events (93, 94).
    # "Miramar" (event on 2026-07-17) and "Residential – Annapolis Neck, MD"
    # are known real-workbook data-entry issues, corrected here per prior
    # confirmation: Miramar -> Hebrew Home of Greater Washington (was a POC
    # name, not the client), Residential name shortened (city was redundant
    # with Location Detail already carrying it).
    rows = [
        ...
        ("Hampton Inn & Suites", "Washington, DC", "Completed", 50, "Yes", "2026-04-24", "Washington, DC"),
        ("Macy's", "Maryland", "Completed", 180, "Yes", "2026-04-27", "Frederick, MD"),
        ("Davis Polk & Wardwell", "Washington, DC", "Completed", 50, "Yes", "2026-04-29", "Washington, DC"),
        ("Hebrew Home of Greater Washington", "Maryland", "Completed", 45, "Yes", "2026-04-29", "North Bethesda, MD"),
        ...
        ("Office of MD Senator Chris Van Hollen", "Maryland", "Completed", 50, "Yes", "2026-05-13", "Rockville, MD"),
        ...
        ("USDA", "Washington, DC", "Completed", 200, "Yes", "2026-05-27", "Washington, DC"),
        ("PepsiCo", "Maryland", "Completed", 50, "Yes", "2026-05-28", "Cheverly, MD"),
        ("USDA", "Washington, DC", "Completed", 175, "Yes", "2026-05-28", "Washington, DC"),
        ("USDA", "Washington, DC", "Completed", 320, "Yes", "2026-06-01", "Washington, DC"),
        ("USDA", "Washington, DC", "Completed", 320, "Yes", "2026-06-02", "Washington, DC"),
        ("USDA", "Washington, DC", "Completed", 200, "Yes", "2026-06-03", "Washington, DC"),
        ("TJ Maxx", "Maryland", "Completed", 96.66, "Yes", "2026-06-03", "Rockville, MD"),
        ("USDA", "Washington, DC", "Completed", 140, "Yes", "2026-06-04", "Washington, DC"),
        ("Hilton Garden Inn", "Virginia", "Completed", 25, "Yes", "2026-06-05", "Fairfax, VA"),
        ("Hebrew Home of Greater Washington", "Maryland", "Completed", 50, "Yes", "2026-06-05", "North Bethesda, MD"),
        ...
        ("Office of MD Senator Angela Alsobrooks", "Maryland", "Completed", 130, "Yes", "2026-06-18", "Bowie, MD"),
        ("Hebrew Home of Greater Washington", "Maryland", "Completed", 70, "Yes", "2026-06-18", "North Bethesda, MD"),
        ("Weis Markets", "Maryland", "Completed", 90, "Yes", "2026-06-19", "Callaway, MD"),
        ("Giant Food Stores", "Washington, DC", "Completed", 50, "Yes", "2026-06-19", "Washington, DC"),
        ("Hebrew Home of Greater Washington", "Maryland", "Completed", 60, "Yes", "2026-06-22", "North Bethesda, MD"),
        ("Food Lion", "Maryland", "Completed", 116.24, "Yes", "2026-06-23", "Upper Marlboro, MD"),
        ("Hilton Garden Inn", "Washington, DC", "Completed", 132.03, "Yes", "2026-06-24", "Washington, DC"),
        ("7-Eleven", "Maryland", "Completed", 120, "Yes", "2026-06-30", "Owings Mills, MD"),
        ("Office of MD Senator Angela Alsobrooks", "Maryland", "Completed", 120, "Yes", "2026-07-01", "Largo, MD"),
        ...
        ("WeWork", "Washington, DC", "Completed", 90, "Yes", "2026-07-17", "Washington, DC"),
        ("Hebrew Home of Greater Washington", "Maryland", "Completed", 50, "Yes", "2026-07-17", "North Bethesda, MD"),
        ...
        ("Baskin-Robbins", "Maryland", "Completed", 240, "Yes", "2026-07-27", "Bel Air, MD"),
        ("Marshalls", "Maryland", "Completed", 270, "Yes", "2026-07-28", "Hyattsville, MD"),
        ("WeWork", "Washington, DC", "Completed", 164.5, "Yes", "2026-07-28", "Washington, DC"),
