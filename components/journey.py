...
.journey-replay-car { position: absolute; left: -.12rem; top: .9rem; z-index: 5; width: 80px; height: 80px; display: flex; align-items: center; justify-content: center; padding: 0; appearance: none; -webkit-appearance: none; border-radius: 999px; background: transparent; border: 1px solid rgba(248,250,252,.2); box-shadow: 0 0 0 2px rgba(244,114,182,.25), 0 0 13px rgba(244,114,182,.4), 0 7px 15px rgba(0,0,0,.4); color: #fff; font-size: 1rem; line-height: 1; opacity: 0; pointer-events: none; cursor: pointer; transform: translateY(-50%); transition-property: top, opacity; transition-timing-function: cubic-bezier(.2,.72,.22,1); }
