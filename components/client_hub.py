...
def render_client_standings(metrics: ExecutiveMetrics, timeline: pd.DataFrame, gross_view: bool = False) -> None:
    ...
    for rank, item in enumerate(directory, start=1):
        ...
        row_html = (
            ...
            f'<div class="row-info">{avatar_html}'
    ...
    *{{box-sizing:border-box;margin:0;padding:0;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}}html,body{{width:100%;overflow:hidden;background:transparent}}body{{color:#fff}}
    ...
    .search-box{{width:100%;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:12px;padding:8px 12px;font-size:12px;color:#d7deea;outline:none;margin-bottom:12px}}.client-list{{display:flex;flex-direction:column;gap:6px}}.client-row{{display:flex;flex-direction:column;gap:8px;background:rgba(15,20,32,.4);border:1px solid rgba(255,255,255,.05);border-radius:12px;padding:9px 12px;cursor:pointer}}.client-row:hover{{border-color:rgba(244,114,182,.3)}}.row-top{{display:grid;grid-template-columns:20px minmax(0,1fr) auto 16px;align-items:center;gap:8px}}.row-rank{{font-size:12px;font-weight:800;color:#64748b;text-align:center}}.row-rank.rank-medal{{width:20px;height:20px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:900;box-shadow:0 2px 6px rgba(0,0,0,.45),inset 0 1px 0 rgba(255,255,255,.55)}}.row-rank.rank-gold{{background:linear-gradient(135deg,#fff6d8,#e8b923 55%,#a9760a);color:#3a2600}}.row-rank.rank-silver{{background:linear-gradient(135deg,#f4f7fb,#c3cad4 55%,#8b95a1);color:#20242b}}.row-rank.rank-bronze{{background:linear-gradient(135deg,#f2c199,#c97a3d 55%,#7c4a20);color:#2a1608}}.row-info{{min-width:0;display:flex;align-items:center;gap:8px}}.row-avatar{{width:22px;height:22px;border-radius:6px;background:rgba(255,255,255,.08);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:800;color:#38bdf8;flex-shrink:0}}.row-avatar.has-logo{{background:#f8fafc;padding:2px}}.row-avatar img{{width:100%;height:100%;object-fit:contain;border-radius:4px}}.row-name{{overflow:hidden;font-size:13px;font-weight:700;text-overflow:ellipsis;white-space:nowrap}}.row-stats{{display:grid;grid-template-columns:repeat(4,1fr);gap:6px;padding-top:8px;border-top:1px solid rgba(255,255,255,.06)}}.row-stat{{text-align:center}}.row-stat-val{{font-size:17px;font-weight:800;color:#e5edf9;line-height:1.2}}.row-stat-lbl{{font-size:9.5px;font-weight:700;letter-spacing:.4px;color:#64748b;text-transform:uppercase;margin-top:1px}}.row-chevron{{font-size:16px;color:#64748b;text-align:center;transition:transform .2s ease}}.client-row.is-open .row-chevron{{transform:rotate(90deg);color:#f472b6}}.empty-directory{{padding:12px;color:#64748b;font-size:12px;text-align:center}}
